...
const PLANS = [
  {
    ...
    period: "/mo",
    features: [
      "1 CPU stage (10 hrs/mo)",
      "2 GPU hrs/mo",
      "720p resolution",
      "Dazzle destination only",
      "Public stages",
    ],
  },
  {
    ...
    period: "/mo",
    features: [
      "1 always-on CPU stage",
      "10 GPU hrs/mo ($0.95/hr overage)",
      "720p resolution",
      "Dazzle + 2 external destinations",
      "Public stages",
    ],
  },
  {
    ...
    popular: true,
    features: [
      "3 always-on CPU stages",
      "30 GPU hrs/mo ($0.80/hr overage)",
      "720p resolution",
      "Dazzle + 5 external destinations",
      "Private stages",
    ],
  },
];
