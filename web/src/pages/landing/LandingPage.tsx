...
export function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen bg-zinc-950 overflow-hidden selection:bg-emerald-500/30">
      ...
      {/* ── How It Works ── */}
      <section id="under-the-hood" className="relative z-10 px-6 py-24 md:py-32 overflow-hidden">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3 mb-16">
            {[
              ...
              <motion.div
                key={feature.title}
                className="rounded-2xl border border-white/[0.06] bg-white/[0.015] p-6 transition-all duration-300 hover:border-emerald-500/20 hover:bg-emerald-500/[0.02] min-w-0"
                initial={{ opacity: 0, y: 16 }}
