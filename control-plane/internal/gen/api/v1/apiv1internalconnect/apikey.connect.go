...
const (
	...
	ApiKeyServiceName = "dazzle.internal.v1.ApiKeyService"
)
...
const (
	...
	// CreateApiKey RPC.
	ApiKeyServiceCreateApiKeyProcedure = "/dazzle.internal.v1.ApiKeyService/CreateApiKey"
	// ApiKeyServiceListApiKeysProcedure is the fully-qualified name of the ApiKeyService's ListApiKeys
	// RPC.
	ApiKeyServiceListApiKeysProcedure = "/dazzle.internal.v1.ApiKeyService/ListApiKeys"
	// ApiKeyServiceDeleteApiKeyProcedure is the fully-qualified name of the ApiKeyService's
	// DeleteApiKey RPC.
	ApiKeyServiceDeleteApiKeyProcedure = "/dazzle.internal.v1.ApiKeyService/DeleteApiKey"
)

// ApiKeyServiceClient is a client for the dazzle.internal.v1.ApiKeyService service.
...
// NewApiKeyServiceClient constructs a client for the dazzle.internal.v1.ApiKeyService service. By
...
// CreateApiKey calls dazzle.internal.v1.ApiKeyService.CreateApiKey.
...
// ListApiKeys calls dazzle.internal.v1.ApiKeyService.ListApiKeys.
...
// DeleteApiKey calls dazzle.internal.v1.ApiKeyService.DeleteApiKey.
...
// ApiKeyServiceHandler is an implementation of the dazzle.internal.v1.ApiKeyService service.
...
func NewApiKeyServiceHandler(svc ApiKeyServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/dazzle.internal.v1.ApiKeyService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedApiKeyServiceHandler) CreateApiKey(context.Context, *connect.Request[v1.CreateApiKeyRequest]) (*connect.Response[v1.CreateApiKeyResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("dazzle.internal.v1.ApiKeyService.CreateApiKey is not implemented"))
}
...
func (UnimplementedApiKeyServiceHandler) ListApiKeys(context.Context, *connect.Request[v1.ListApiKeysRequest]) (*connect.Response[v1.ListApiKeysResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("dazzle.internal.v1.ApiKeyService.ListApiKeys is not implemented"))
}
...
func (UnimplementedApiKeyServiceHandler) DeleteApiKey(context.Context, *connect.Request[v1.DeleteApiKeyRequest]) (*connect.Response[v1.DeleteApiKeyResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("dazzle.internal.v1.ApiKeyService.DeleteApiKey is not implemented"))
}
